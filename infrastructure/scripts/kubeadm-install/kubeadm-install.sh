...
echo "    1. Ensure this script has been executed successfully on ALL cluster nodes."
echo "    2. Refer to your deployment documentation (vm-setup.md) to initialize"
echo "       your control plane and join your workers."
echo ""
